...
public class ListLopHoc {
    private ArrayList<LopHoc> listLopHoc; // lay thong tin cac lop hoc ma GV day + vai tro GV trong lop

    public ListLopHoc() {
        this.listLopHoc = new ArrayList<>();
    }

    public ListLopHoc(ArrayList<LopHoc> dsLopHoc) {
        this.listLopHoc = dsLopHoc;
    }
